...
public class TrainerDashboard extends Controller
{
  ...
  public static void editGymClassDetails(Long id, GymClass gymclass1)
  {
    ...
    gymclass.startDate = gymclass1.startDate;
  ...
  public static void addGymClass(String name, double duration, String timeSlot, int capacity, int weeks, String difficulty)
  {
    Logger.info("Creating Gym Class " + name);

    GymClass gymclass = new GymClass(name, duration, timeSlot, capacity, weeks, difficulty);
    gymclass.save();
    index();
    redirect("/trainerdashboard");
  }
